    ...
    <?php $form = ActiveForm::begin([
        ...
        <div class="row gx-3 gy-2 justify-content-between mt-1"><!-- Dòng 2: 4 cột -->
            ...
            <div class="col-md-3">
                ...
                <?php 
                   $statuses = KpiWorkAssignmentStatus::find()->all();
...
$this->registerJs(<<<JS
    ...
    /* $('#btn-export-pdf').on('click', function (e) {
        ...
        $.ajax({
            url: '/work-assignment/report/pdf-tuan',
            type: 'POST',
            data: form.serialize(),
            xhrFields: {
                responseType: 'blob'      // rất quan trọng để nhận file PDF
            },
    ...
    $('#btn-export-pdf').on('click', function (e) {
        ...
        $.ajax({
            url: '/work-assignment/report-export/pdf-tuan',
            type: 'POST',
            data: form.serialize(),
            xhrFields: {
    ...
    $('#btn-export-word').on('click', function (e) {
        ...
        let form = $('#filterForm');
        $.ajax({
            url: '/work-assignment/report-export/word-tuan',
            type: 'POST',
            data: form.serialize(),
    ...
    $('#btn-export-excel').on('click', function (e) {
        ...
        let form = $('#filterForm');
        $.ajax({
            url: '/work-assignment/report-export/excel-tuan',
            type: 'POST',
            data: form.serialize(),
            xhrFields: { responseType: 'blob' },
            success: function (data, status, xhr) {
