...
/**
 * DepartmentsSearch represents the model behind the search form about `app\modules\departments\models\DepartmentsForm`.
 */
class DepartmentsSearch extends DepartmentsForm
{
    /**
     * @inheritdoc
     */
