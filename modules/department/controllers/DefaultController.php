...
use app\modules\department\models\DepartmentSearch;
...
/**
 * DefaultController implements the CRUD actions for DepartmentForm model.
 */
class DefaultController extends Controller
{
    ...
    /**
     * Lists all DepartmentForm models.
     * @return mixed
     */
    ...
    {    
        $searchModel = new DepartmentSearch();
  		if(isset($_POST['search']) && $_POST['search'] != null){
            ...
            $searchModel = new DepartmentSearch(); // "reset"
    ...
    /**
     * Displays a single DepartmentForm model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DepartmentForm model.
    ...
    /**
     * Updates an existing DepartmentForm model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing DepartmentForm model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing DepartmentForm model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the DepartmentForm model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DepartmentForm the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DepartmentForm::findOne($id)) !== null) {
            return $model;
        } else {
